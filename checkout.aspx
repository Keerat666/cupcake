<%@ Page Language="C#" AutoEventWireup="true" CodeFile="checkout.aspx.cs" Inherits="checkout" EnableSessionState="True" %>
      ...
      <div class="table-responsive">
          <asp:Table class="table table-hover" runat="server" ID="info" BorderStyle="Solid">
              <asp:TableHeaderRow BorderStyle="Solid">
                  ...
                  <asp:TableCell BorderStyle="Solid">Room Type</asp:TableCell>
              </asp:TableHeaderRow>
          </asp:Table>
      </div>
  </div>
