<%@ Page Language="C#" AutoEventWireup="true" CodeFile="room-detail.aspx.cs" Inherits="room_detail" EnableSessionState="True" %>
  ...
  <div class="row"> 
    ...
    <section class="standard-slider room-slider">
      <div class="col-sm-12 col-md-8">
        <div id="owl-standard" class="owl-carousel">
          <div class="item"> <a href="images/rooms/slider/s1.jpg" data-rel="prettyPhoto[gallery1]"><img src="images/rooms/slider/s1.jpg" alt="Image 2" class="img-responsive"/></a> </div>
          <div class="item"> <a href="images/rooms/slider/s2.jpg" data-rel="prettyPhoto[gallery1]"><img src="images/rooms/slider/s2.jpg" alt="Image 2" class="img-responsive"/></a> </div>
          <div class="item"> <a href="images/rooms/slider/s3.jpg" data-rel="prettyPhoto[gallery1]"><img src="images/rooms/slider/s3.jpg" alt="Image 2" class="img-responsive"/></a> </div>
        </div>
      </div>
    </section>
    ...
    <section id="reservation-form" class="mt50 clearfix">
      <div class="col-sm-12 col-md-4">
        <form class="reservation-vertical clearfix" role="form" runat="server" name="reservationform" id="reservationform">
          <h2 class="lined-heading"><span style="background-color:#e8e0c5">Reservation</span></h2>
          <!-- Error message display -->
          <div class="form-group" runat="server">
            <label for="email" accesskey="E">E-mail</label>
            <input name="email"  runat="server" id="email" value="" class="form-control" placeholder="Please enter your E-mail"/>
          </div>
          ...
          <div class="form-group">
            ...
            <input name="checkin"  runat="server" type="text" id="checkin" value="" class="form-control" placeholder="Check-in"/>
          </div>
          <div class="form-group">
            <label for="checkout">Check-out</label>
            <div class="popover-icon" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="right" data-content="Check-out is from 12:00"> <i class="fa fa-info-circle fa-lg"> </i> </div>
            <i class="fa fa-calendar infield"></i>
            <input runat="server" name="checkout" type="text" id="checkout" value="" class="form-control" placeholder="Check-out"/>
          </div>
                <div class="form-group">
          ...
          <div class="form-group">
            ...
            <asp:Button runat="server" ID="subbut" class="btn btn-primary btn-block" Text="Book Now" OnClick="subbut_Click" UseSubmitBehavior="false"  />
        </form>
      </div>
    </section>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-3 col-sm-3">
        <h4>About Al Salam Grand Hotel</h4>
