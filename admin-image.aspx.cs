    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (fname != null)
            {
                ...
                if (File.Exists(@"C:\Users\gurke\source\WebSites\home\images\gallery\" + fname))
                {
                    File.Delete(@"C:\Users\gurke\source\WebSites\home\images\gallery\" + fname);
                }
                System.IO.File.Move(@"C:\Users\gurke\source\WebSites\home\images\temp\" + imgName, @"C:\Users\gurke\source\WebSites\home\images\\gallery\" + fname);
            }
        }
